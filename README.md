...
Set `content.fatality.io` as the content server:

```shell
echo '{ "content": "content.fatality.io" }' > bin/web.json
```
...
and you should be able to join at http://fatality.io/play?connect%20SERVER_IP:27960, replacing `SERVER_IP` with the IP of your server.
